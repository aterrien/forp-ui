...
this.ctx.beginPath();this.ctx.strokeStyle='#4D90FE';this.ctx.lineWidth=30;this.ctx.moveTo(idx,this.conf.yaxis.length);this.ctx.lineTo(idx,this.conf.yaxis.length-
((this.conf.val.call(this,idx)*this.conf.yaxis.length)/this.conf.yaxis.max));this.ctx.closePath();this.ctx.stroke();};this.draw=function(){if(!this.drawn){this.drawn=true;var len=this.datas.length;this.element.width=len;this.element.height=this.conf.yaxis.length;this.element.style.width='100%';this.element.style.height=this.conf.yaxis.length+'px';this.element.style.marginBottom='-3px';this.element.style.backgroundColor='#333';this.ctx.beginPath();for(var i=0;i<len;i++){this.ctx.strokeStyle=this.conf.color.call(this,i);this.ctx.lineWidth=30;this.ctx.moveTo(i,this.conf.yaxis.length);this.ctx.lineTo(i,this.conf.yaxis.length-
