...
trs.sort(function(a,b){var aval=a.childNodes[index].innerHTML.replace(/<.*?>/g,''),bval=b.childNodes[index].innerHTML.replace(/<.*?>/g,'');if(aval<bval){return order?-1:1;}else if(aval>bval){return order?1:-1;}
